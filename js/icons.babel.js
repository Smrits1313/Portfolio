/* Inline SVG icons. lucide-style (currentColor stroke) + Material (currentColor fill). */
(function () {
  ...
  // ---- Material icons (single-path, fill currentColor) ----------------------
  ...
  window.MaterialPaths = MaterialPaths;

  const MaterialIcon = ({ path, className = "" }) => (
    <svg
      className={className}
      viewBox="0 0 24 24"
      fill="currentColor"
